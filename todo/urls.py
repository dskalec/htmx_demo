...
from .views import (
    ...
    ajax_complete_todo_view, ajax_delete_todo_view, ajax_edit_todo_view, ajax_add_todo_view
)
...
urlpatterns = [
    ...
    path("ajax-edit/<int:pk>/", ajax_edit_todo_view, name="ajax_edit"),
    path("ajax-add/", ajax_add_todo_view, name="ajax_add")
]
